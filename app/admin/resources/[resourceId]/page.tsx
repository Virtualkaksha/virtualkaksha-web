...
export default async function AdminResourceReviewPage({ params, searchParams }: { params: Promise<{ resourceId: string }>; searchParams: Promise<{ approved?: string; rejected?: string; rateLimited?: string; retryAfter?: string }> }) {
