      ...
      <section className="overflow-hidden rounded-3xl bg-slate-950 px-6 py-10 text-white sm:px-10 lg:px-12">
        <div className="max-w-4xl">
          ...
          <p className="mt-5 max-w-3xl text-sm leading-7 text-slate-300 sm:text-base">
            ...
            previous-year questions and practice material for {catalog.board.shortName}{" "}
            {catalog.classLevel.name}.
          </p>
          ...
          <div className="mt-8 grid max-w-3xl gap-3 sm:grid-cols-3">
            ...
            <Stat
              value={catalog.totals.publishedResources}
        ...
        <div className="flex flex-col justify-between gap-5 md:flex-row md:items-center">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-600">
              Return to the {catalog.board.shortName} class catalogue and select
              a different class.
            </p>
          </div>
          <Link
