  ...
  return (
    <div className="mx-auto max-w-7xl space-y-7">
      <header className="rounded-3xl border border-slate-200 bg-white px-6 py-8 shadow-sm sm:px-10">
        ...
        <h1 className="mt-3 text-3xl font-bold text-slate-900">Search learning resources</h1>
        <p className="mt-3 text-sm leading-6 text-slate-600">Search published, free resources by title, chapter, subject, or teacher. Curated order is the default; it is not full-text relevance ranking.</p>
      ...
      <ResourceSearchResults items={result.items} />
