...
const tests = [
  ...
  },
  {
    ...
    description: "Simulate real exam conditions with full-length mock tests.",
    icon: "🎯",
  },
  {
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {tests.map((test) => (
            <div
              key={test.title}
              className="rounded-3xl border border-slate-200 bg-slate-50 p-6 transition duration-300 hover:-translate-y-1 hover:shadow-lg"
            >
